        ...
        {open && (
          <div className="absolute left-0 top-0 z-50 flex h-[100vh] w-full animate-fadeInLeft flex-col items-center gap-10 bg-white p-10 text-xl text-black">
            ...
            <div className="flex cursor-pointer flex-row items-center justify-center">
              <a
                className="flex cursor-pointer flex-row content-center items-center justify-center rounded-full bg-[#243c60] p-5 text-white hover:bg-[#BBC3CE] hover:text-[#101B2B]"
                onClick={handleMenu}
                ...
                target="_blank"
              >
                <p className="relative top-[2px]">ORÇAMENTAR</p>
                <Image
                  src="/head/whatsapp.svg"
                  width={35}
                  height={35}
                  alt=""
                  className="ml-5 flex"
